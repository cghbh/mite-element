<template>
	<div>
		<m-tabs v-model="activeName" type="card">
			<m-tabs-item label="满江红·写怀" name="1" icon="loading">
			...
			<m-tabs-item label="苏幕遮·燎沉香" name="4" icon="star">
